...
class Categories(models.Model):
    ...
    image = models.ImageField(upload_to='categories/', blank=True, null=True)  # Поле для изображения
...
class Subcategories(models.Model):
    ...
    image = models.ImageField(upload_to='subcategories/', blank=True, null=True)  # Поле для изображения
...
class Products(models.Model):
    ...
    subcategory = models.ForeignKey('Subcategories', on_delete=models.CASCADE, related_name='products')
    supplier = models.ForeignKey('Suppliers', on_delete=models.CASCADE, related_name='products')
    image = models.ImageField(upload_to='products/images/', blank=True, null=True)  # Новое поле для изображений
